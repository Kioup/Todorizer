--><main>
<div class="ariane">
<span><a href='<?php echo "redirect.php?projectId=" . $project->getId() . "&view=rootNodeList" ;?>'><?php echo $project->getName(); ?></a></span>
            <?php
...
foreach ($DecomposedNodePath as $key=>$partOfPath){
    ...
    if ($first == TRUE)  {      
        ...
        echo ' <span> <i class="fa fa-caret-right"></i> ';
        echo '<a href="'. $nodeLineString .'" style="color:white;">';
        echo ($sortedNodeList[$FullNodePath])->getTitle();
        echo '</a></span>';
    } 
}
/// fin du fil d'ariane
